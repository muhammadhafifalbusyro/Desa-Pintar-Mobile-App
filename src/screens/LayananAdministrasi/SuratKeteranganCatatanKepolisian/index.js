...
class SuratKeteranganCatatanKepolisian extends React.Component {
  state = {
    loading: false,
    visible: false,
    modalVisible: false,
  ...
  tambahLayanan = () => {
    const {keterangan, keperluan, defaultPenduduk} = this.state;
    if (
      defaultPenduduk != 'Select ...' &&
      keterangan != '' &&
      keperluan != ''
      ...
      const url = 'https://api.istudios.id/v1/layanansurat/skck/';
...
export default SuratKeteranganCatatanKepolisian;
