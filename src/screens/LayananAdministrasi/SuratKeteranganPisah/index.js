...
class SuratKeteranganPisah extends React.Component {
  state = {
    data: [],
    loading: false,
    token: '',
    defaultPenduduk1: 'Select ...',
    defaultPenduduk2: 'Select ...',
    visible: false,
    visible2: false,
    instansi_pengadilan: '',
    nama_keperluan: '',
  ...
  tambahLayanan = () => {
    ...
    if (
      ...
      const url = 'https://api.istudios.id/v1/layanansurat/ket_pisah/';

      const datas = {
        atribut: {
          nama_pasangan: defaultPenduduk2,
          nama_instansi_pengadilan: instansi_pengadilan,
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View
            ...
            <Text style={{color: 'grey', fontWeight: 'bold'}}>Pemohon</Text>
          </View>
          ...
          <View
            ...
            <Text style={{marginBottom: 10, color: 'grey', fontWeight: 'bold'}}>
              Nama Instansi Pengadilan
            </Text>
            <TextInput
              value={this.state.instansi_pengadilan}
              onChangeText={(teks) =>
                this.setState({instansi_pengadilan: teks})
              }
              style={{
                width: '100%',
                height: 45,
          ...
          <View
            ...
            <TextInput
              value={this.state.nama_keperluan}
              onChangeText={(teks) => this.setState({nama_keperluan: teks})}
...
export default SuratKeteranganPisah;
