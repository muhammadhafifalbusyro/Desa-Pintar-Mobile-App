...
class SuratKeteranganAhliWarisNonTunggal extends React.Component {
  ...
  tambahLayanan = () => {
    const {kematianID, defaultName, hubungan_almarhum, reg_dtks} = this.state;
    ...
    if (
      ...
      const url = 'https://api.istudios.id/v1/layanansurat/kaw_nontunggal/';

      const datas = {
        atribut: {
          kematian_id: kematianID,
          hubungan_dengan_almarhum: hubungan_almarhum,
          reg_dtks: reg_dtks,
        },
      };
      axios
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View
            ...
            <TextInput
              value={this.state.hubungan_almarhum}
              onChangeText={(teks) => this.setState({hubungan_almarhum: teks})}
              style={{
                width: '100%',
                height: 45,
                borderWidth: 1,
          ...
          <View
            ...
            <TextInput
              value={this.state.reg_dtks}
              onChangeText={(teks) => this.setState({reg_dtks: teks})}
              style={{
                width: '100%',
                height: 45,
                borderWidth: 1,
